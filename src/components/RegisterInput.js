    ...
    render() {
        return (
            <form onSubmit={this.onSubmitHandler} className="register-input">
                ...
                <input type="password" placeholder="Password" autoComplete="current-password" value={this.state.pasword} onChange={this.onPasswordChange} />
